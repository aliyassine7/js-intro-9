// Extractig characters from the string
...
console.log(obj.charAt(obj.length - 2) + obj.charAt(obj.charAt - 1)) // 'er'
console.log(obj.at(-2) + obj.at(-1)); // 'er'

/*
TASK: used to retrieve/get a character at specified index
RETURN: it returns a single character as a string
NOTE: If the index is not negative, it goes backward and returns a charcter at the found index
