...
// 2. using array constrcutor with new keyword
...
console.log(arr1); // []
console.log(arr2); // []
const arr3 = name.split(''); // [ 'J', 'o', 'h', 'n' ]
const arr4 = sentence.split(' ') // [ 'I', 'like', 'arrays' ]
...
typeof operator cannot be used as it returns object fir the array
However, isArray() static method returns if the given variable is actually an array
*/
